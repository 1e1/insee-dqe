...
class UserTagsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create user_tag" do
    assert_difference('UserTag.count') do
      post user_tags_url, params: { user_tag: { group: @user_tag.group, name: @user_tag.name, user_id: @user_tag.user_id } }
    end
  ...
  test "should update user_tag" do
    patch user_tag_url(@user_tag), params: { user_tag: { group: @user_tag.group, name: @user_tag.name, user_id: @user_tag.user_id } }
